* Dockerize application to make it deployable on K8 clusters
...
* Add IP address to the user rating table to avoid duplicate brute force attacking requests or duplicate voting.
